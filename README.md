...
```mermaid
graph LR
    A[🔭 Currently Working On] --> B[I'm currently working on 3 projects... Karigari - the AI marketplace for Indian Artisans, Kisanlog - Farmer Input Expense Tracker, Clarify - Everyday personal basic needs assistant the mobile app.]
    C[🌱 Learning] --> D[Generative AI, Machine Learning.]
    E[💬 Ask Me About] --> F[MERN Stack Development, Learning Generative AI]
    G[⚡ Fun Fact] --> H[Sometimes I forget to overthink!]
